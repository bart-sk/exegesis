 ...
 */
export type ExegesisRunner = (req: http.IncomingMessage, res: http.ServerResponse, ctx: KoaContext) => Promise<HttpResult | undefined>;
...
export interface ExegesisPluginInstance {
     ...
     */
    postBodyParsed?: ((pluginContext: ExegesisPluginContext) => void | Promise<void>) | ((pluginContext: ExegesisPluginContext, done: Callback<void>) => void);
    /**
