...
function _fixNullables(schema) {
    (0, json_schema_traverse_1.default)(schema, (childSchema) => {
        ...
        if (childSchema.additionalProperties) {
            const resolvedProp = (0, json_schema_resolve_ref_1.resolveRef)(schema, childSchema.additionalProperties);
            if (resolvedProp.nullable) {
                childSchema.additionalProperties = { anyOf: [{ type: 'null' }, childSchema.additionalProperties] };
            }
        }
        if (childSchema.items) {
            const resolvedItems = (0, json_schema_resolve_ref_1.resolveRef)(schema, childSchema.items);
