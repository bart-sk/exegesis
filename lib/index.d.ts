 ...
 */
export declare function writeHttpResult(httpResult: HttpResult, ctx: KoaContext): Promise<void>;
/**
 * Convenience function which writes an `HttpResult` obtained from an
 * ExegesisRunner out to an HTTP response.
 *
 ...
 */
export declare function writeHttpResult(httpResult: HttpResult, ctx: KoaContext, done: Callback<void>): void;
/**
 ...
 */
export declare function compileApi(openApiDoc: string | oas3.OpenAPIObject, options?: ExegesisOptions | undefined): Promise<MiddlewareFunction>;
/**
 * Returns a connect/express middleware function which implements the API.
 *
 * @param openApiDoc - A string, representing a path to the OpenAPI document,
